...
Skilled in **AWS (EC2, RDS, Secrets Manager)**, **error handling**, and integrating **AI models** like ** Spring AI, OpenAI LLM**, and **Ollama**.  
Strong understanding of **OOP principles**, clean modular code, and practical experience from internships & projects. 
...
**⚙️ Core Concepts:** Data Structures & Algorithms, OOP, Problem Solving. 

**🌱 Frameworks & Libraries:** Spring, Spring Boot, Lombok, Jackson, SonarQube. 

**🧩 Back-End:** RESTful APIs, Microservices Architecture. 

**🎨 Front-End:** React.js.  

**🤖 AI & LLMs:** Spring AI, OpenAI LLM, Llama LLM, Copilot, Cursor AI.  

**🗄️ Databases:** MySQL.  

**☁️ Cloud:** AWS (EC2, RDS, Secrets Manager).  
...
**Java Developer Trainee | HulkHire Tech, Hyderabad (Jan 8, 2024 – April 26, 2024)**  
...
🔗 [Project Link](https://github.com/smansoor481/Stripe-Payment-Integration)
...
- ☁️ **Spring Boot & Spring Framework 6 – LinkedIn Learning** 
- 💻 **Datacom Virtual Experience – Forage**

---

## 🎓 Education
**Bachelor of Technology (B.Tech) – Electronics & Communication Engineering**  
Gates Institute of Technology, Gooty, Anantaput, Andhra Pradesh 
📅 June 2020 – May 2024 | GPA: 7.79/10   
